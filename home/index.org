...
In the computing area I’m mostly focused on system programming, reverse engineering, cybersecurity, unix-like operating systems, libre software and lisp.

*PROJECTS*

- [[https://github.com/ctznfive/tdpad][TDPad]] : Qt text editor with task manager functionality
- [[https://github.com/ctznfive/muswebp][MusWebP]] : Simple web based music player
- [[https://github.com/ctznfive/vergeos][VergeOS]] : Elements of barebones operating system written in NASM
